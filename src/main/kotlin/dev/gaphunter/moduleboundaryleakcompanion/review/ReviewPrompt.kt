package dev.gaphunter.moduleboundaryleakcompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.moduleboundaryleakcompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.moduleboundaryleakcompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Module Boundary Leak Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33997-module-boundary-leak-companion/reviews"
